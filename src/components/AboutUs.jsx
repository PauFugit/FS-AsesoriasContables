      ...
      <div className="container mx-auto py-12">
        ...
        <div className="mt-12 grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="text-left">
            <h2 className="text-4xl text-custom-white mb-4">QUIÉNES SOMOS</h2>
          ...
          <h2 className="text-4xl text-custom-white mb-4">HISTORIA</h2>
          ...
          <div className="text-left">
          <h2 className="text-4xl text-custom-white mb-4">NUESTROS SERVICIOS</h2>
          ...
          <div className="text-right">
            <h2 className="text-4xl text-custom-white mb-4">NUESTROS CLIENTES</h2>
