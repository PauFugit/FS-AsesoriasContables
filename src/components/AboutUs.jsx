...
const AboutUs = () => {
  return (
    ...
    <header className="bg-custom-blue text-white text-center py-8">
        <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl" style={{letterSpacing:"0.5rem"}}>ASESORÍAS VALDIVIA</h1>
      </header>
