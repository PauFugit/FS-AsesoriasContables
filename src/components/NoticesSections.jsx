...
const newsItems = [
    {
        ...
        content: "En el mundo de las finanzas personales, uno de los consejos más repetidos por expertos es simple pero poderoso: 'Gasta menos de lo que ganas y ahorra al menos el 20% de tus ingresos'. Este principio, según economistas y asesores financieros, es la clave para alcanzar la estabilidad económica a largo plazo y construir un patrimonio sólido. Al vivir por debajo de tus posibilidades y mantener un enfoque constante en el ahorro, las personas pueden prepararse para emergencias financieras, generar inversiones a futuro y evitar endeudamientos innecesarios.  El hábito de ahorrar de manera constante se ha destacado como uno de los pilares esenciales para la independencia financiera, especialmente en tiempos de incertidumbre económica. Los expertos señalan que, además del ahorro, es crucial que este porcentaje se invierta inteligentemente, ya sea en fondos de inversión, bienes raíces u otros activos que generen rendimientos. La disciplina financiera, acompañada de una estrategia de inversión adecuada, permite que cualquier persona, independientemente de su nivel de ingresos, construya riqueza con el tiempo.",
        href: "",
    },
    {
        id: 2,
            ...
            {isModalOpen && (
                ...
                <div className="z-50 fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4">
                    <div className="bg-white rounded-lg p-4 sm:p-6 md:p-8 lg:p-16 w-full max-w-3xl max-h-[90vh] overflow-y-auto">
                       ...
                       {/* <p className="text-xs sm:text-sm p-2 sm:p-4">
                            Fuentes: 
                            {selectedNews.href && <Link href={selectedNews.href} className="text-custom-blue hover:underline ml-1" />}
                            {selectedNews.hreftwo && <Link href={selectedNews.hreftwo} className="text-custom-blue hover:underline ml-1" />}
                        </p>*/}
                        <button
                            onClick={closeModal}
