...
const WhatsAppButton = () => {
  ...
  return (
    <Link href={`https://wa.me/${whatsappNumber}?text=${encodeURIComponent(message)}`} passHref>
      <p 
        className="fixed bottom-4 right-4 bg-custom-green text-white p-4 rounded-full shadow-lg hover:bg-green-600 transition duration-300 flex items-center space-x-2"
        target="_blank"
