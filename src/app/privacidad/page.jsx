...
Agradezco que estés en esta página, eso significa que tus datos te importan, y quieres conocer el destino de los mismos y quién los recoge.<br></br>
De conformidad con lo dispuesto en el Reglamento General (UE) Sobre Protección de Datos, mediante la aceptación de la presente Política de Privacidad prestas tu consentimiento informado, expreso, libre e inequívoco para que los datos personales que proporciones a través de la página web asesoriasvaldivia.cl/ (en adelante SITIO WEB) sean incluidos en un fichero de “USUARIOS WEB Y SUSCRIPTORES” así como “CLIENTES Y/O PROVEEDORES”: <br></br><br></br>
<b>•</b>	Mi denominación social es: RICARDO ALEXIS VALDIVIA SALIS <br></br>
<b>•</b>	Mi domicilio social se encuentra en Antofagasta, Chile<br></br>
<b>•</b>	Email: contacto@asesoriasvaldivia.cl <br></br>
<b>•</b>	Mi actividad social es: Servicios contables, laborales, tributarios y auditorias. <br></br><br></br>
La presente Política de Privacidad será válida únicamente para los datos de carácter personal obtenidos en el Sitio Web, no siendo aplicable para aquella información recabada por terceros en otras páginas web, incluso si éstas se encuentran enlazadas por el Sitio Web. <br></br>
Con ello manifiesto mi compromiso por mantener y garantizar las relaciones comerciales de forma seguridad mediante la protección de los datos personales y garantizando el derecho a la privacidad de cada uno de los usuarios de nuestro sitio web. <br></br>
 <br></br><br></br>
<b>1. ¿QUÉ SON LOS DATOS PERSONALES?</b> <br></br><br></br>
Una pequeña aproximación es importante, por ello, debes saber que sería cualquier información relativa a una persona que nos facilita cuando visita nuestro sitio web, en nuestro caso nombre e email, y si compra algún producto necesitando factura, solicitaremos Domicilio completo, nombre, apellidos, rut, email, DNI o CIF. <br></br>
<br></br>
Adicionalmente, cuando visitas nuestro sitio web, determinada información se almacena automáticamente por motivos técnicos como la dirección IP asignada por su proveedor de acceso a Internet.<br></br>
 <br></br>
<b>PRINCIPIOS PARA EL TRATAMIENTO DE DATOS</b> <br></br><br></br>
Para tratar tus datos personales, aplicaré según el RGPD los siguientes principios: <br></br>
...
<br></br>
* Principio de minimización de datos: Solo voy a solicitar datos estrictamente necesarios en relación con los fines para los que los requiero.
<br></br>
* Principio de limitación del plazo de conservación: como más adelante podrás comprobar, los datos serán mantenidos durante no más tiempo del necesario para los fines del tratamiento, en función a la finalidad, te informaré del plazo de conservación correspondiente, en el caso de suscripciones, periódicamente revisaré mis listas y eliminaré aquellos registros inactivos durante un tiempo considerable.
<br></br>
...
<br></br>
* La venta de formación sobre Negocios Online.<br></br>
* La venta de Ebooks , libros y productos.<br></br>
* Gestionar la lista de suscriptores y usuarios adscritos a la web.<br></br>
* Suministro de contenidos en el blog.<br></br>
* Dirigir su red de afiliados y comerciantes así como la gestión de pagos de los mismos. <br></br>
Únicamente el titular tendrá acceso a sus datos, y bajo ningún concepto, estos datos serán cedidos, compartidos, transferidos, ni vendidos a ningún tercero. <br></br>
...
<br></br>
<br></br>
<b>2.2 MENORES DE EDAD</b>
<br></br><br></br>
En el supuesto de ser mayor de dieciocho años, podrás registrarte en https://www.asesoriasvaldivia.cl sin necesidad del consentimiento previo de tus padres o tutores.
<br></br><br></br>
¿Qué ocurre en el caso de que seas menor de 18 años?
<br></br>
En este supuesto, será condición obligatoria el consentimiento de tus padres o tutores para que podamos tratar sus datos personales. <br></br>
...
<br></br><br></br>
<b>2.3 LEGITIMACIÓN</b>
<br></br><br></br>
Gracias al consentimiento, podemos tratar tus datos siendo requisito obligatorio para poder suscribirte a la página web. <br></br>
Como bien sabes, puedes retirar tu consentimiento en el momento que lo desees. <br></br>
<br></br>
<b>2.4 CATEGORÍA DE LOS DATOS</b><br></br><br></br>
Los datos recabados en ningún momento son especialmente protegidos, sino que se encuentran categorizados como datos identificativos. <br></br><br></br>

<b>2.5 TIEMPO DE CONSERVACIÓN DE LOS DATOS</b> <br></br><br></br>
Conservaré tus datos durante el tiempo legalmente establecido o hasta que solicites eliminarlos. <br></br><br></br>
<b>2.6 EXACTITUD Y VERACIDAD DE LOS DATOS</b> <br></br><br></br>
Obviamente eres el único responsable de la veracidad y exactitud de los datos que me remitas eximiéndome de cualquier tipo de responsabilidad al respecto. <br></br><br></br>
...
<br></br>
<br></br>
<b>3. CUMPLIMIENTO DE LA NORMATIVA DE APLICACIÓN</b>
<br></br>
Asesorias Valdivia, cumple con el Reglamento General (UE) sobre Protección de Datos, velando por garantizar un correcto uso y tratamiento de los datos personales del usuario.
<br></br>
En cumplimiento de lo establecido en la normativa, le informamos que los datos suministrados, así como aquellos datos derivados de su navegación, podrán ser almacenados en los ficheros de Asesorias Valdivia y tratados para la finalidad de atender su solicitud y el mantenimiento de la relación que se establezca en los formularios que suscriba.
<br></br>Adicionalmente, el USUARIO consiente el tratamiento de sus datos con la finalidad de informarles, por cualquier medio, incluido el correo electrónico, de productos y servicios de Asesorias Valdivia.
<br></br>En caso de no autorizar el tratamiento de sus datos con la finalidad señalada anteriormente, el USUARIO podrá ejercer su derecho de oposición al tratamiento de sus datos en los términos y condiciones previstos más adelante en el apartado “Ejercicio de Derechos”
 <br></br>
 <br></br>
 <br></br>
<b>4. MEDIDAS DE SEGURIDAD</b>
<br></br>Asesorias Valdivia le informa que tiene implantadas las medidas de seguridad de índole técnica y organizativas necesarias para garantizar la seguridad de sus datos de carácter personal y evitar su alteración, pérdida y tratamiento y/o acceso no autorizado, habida cuenta del estado de la tecnología, la naturaleza de los datos almacenados y los riesgos a que están expuestos, ya provengan de la acción humana o del medio físico o natural. Todo ello de conformidad con lo previsto en el RGPD.
<br></br>
Asimismo, Asesorias Valdivia ha establecido medidas adicionales en orden a reforzar la confidencialidad e integridad de la información en su organización. Manteniendo continuamente la supervisión, control y evaluación de los procesos para asegurar el respeto a la privacidad de los datos.
<br></br>
...
<br></br>
<br></br>
<b>5. EJERCICIO DE DERECHOS</b> <br></br>
Aquellas personas físicas que hayan facilitado sus datos a través de https://www.asesoriasvaldivia.cl , podrán dirigirse al titular de la misma con el fin de poder ejercitar gratuitamente sus derechos de acceso a sus datos, rectificación o supresión, limitación y oposición respecto de los datos incorporados en sus ficheros.
<br></br>
...
<br></br>
<br></br>
<b>6. LINKS O ENLACES EXTERNOS</b> <br></br>
Como un servicio a nuestros visitantes, nuestro sitio web puede incluir hipervínculos a otros sitios que no son operados o controlados por el Sitio Web. Por ello https://www.asesoriasvaldivia.cl / no garantiza, ni se hace responsable de la licitud, fiabilidad, utilidad, veracidad y actualidad de los contenidos de tales sitios web o de sus prácticas de privacidad. Por favor, antes de proporcionar su información personal a estos sitios web ajenos a https://www.asesoriasvaldivia.cl/, tenga en cuenta que sus prácticas de privacidad pueden diferir de las nuestras.
<br></br> 
<br></br>
<br></br>
<b>7. MODIFICACIÓN DE LA POLÍTICA DE PRIVACIDAD</b> <br></br>
Asesorias Valdivia, se reserva el derecho a modificar su Política de Privacidad, de acuerdo a su propio criterio, motivado por un cambio legislativo, jurisprudencial o doctrinal de la Agencia Española de Protección de Datos.
<br></br>
Cualquier modificación de la Política de Privacidad será publicada al menos diez días antes de su efectiva aplicación. El uso de Asesorias Valdivia después de dichos cambios, implicará la aceptación de los mismos.
<br></br>
<br></br>
<br></br>
<b>8. RESPONSABLE DEL FICHERO, Y ENCARGADOS DEL TRATAMIENTO</b>
<br></br>
El responsable del fichero de datos es Asesorias Valdivia.
<br></br>
...
<br></br>Como plataforma de webinars, se utilizan los servicios de Everwebinar.
<br></br>
<br></br>
<br></br>
<b>9. ¿ NO DESEAS RECIBIR INFORMACION DE NOSOTROS O DESEAS REVOCAR TU CONSENTIMIENTO?</b>
<br></br>
...
<br></br>
En relación con la gestión de tus datos asociados a los perfiles sociales de Asesorias Valdivia,el ejercicio del derecho de acceso, dependerá de la funcionalidad de la red social y las posibilidades de acceso a la información de los perfiles de los usuarios. Con relación a los derechos de acceso y rectificación, le recomendamos que sólo podrá satisfacerse en relación a aquella información que se encuentre bajo el control de Asesorias Valdivia.
<br></br>
Además podrá dejar de interactuar, seguir o recibir información de los perfiles sociales de Asesorias Valdivia, eliminar los contenidos que dejen de interesarte o restringir con quien comparte sus conexiones, mediante los mecanismos estipulados en las diferentes redes sociales.
<br></br>
El usuario podrá acceder a las políticas de privacidad de cada Red Social, así como configurar su perfil para garantizar su privacidad Asesorias Valdivia anima a los usuarios a familiarizarse con las condiciones de uso de las distintas redes sociales antes de comenzar a usarlas.
<br></br>
...
<br></br>
<br></br>
<b>10. SISTEMAS DE CAPTURA DE DATOS PERSONALES Y SU FINALIDAD</b>
<br></br>
...
<br></br>
6) Los usuarios podrán darse de baja en cualquier momento de los servicios prestados por https://www.asesoriasvaldivia.cl/ desde la misma Newsletter a través de un formulario de cancelación.
<br></br>
7) Sistemas de rastreo utilizadas en este sitio: Google (Analytics), en https://www.asesoriasvaldivia.cl/  / también se estudian las preferencias de sus usuarios, sus características demográficas, sus patrones de tráfico, y otra información en conjunto para comprender mejor quiénes constituyen su audiencia y qué es lo que esta necesita. El rastreo de las preferencias de nuestros usuarios también nos ayuda a mostrarle los avisos publicitarios más relevantes.
<br></br>
...
<br></br>No voy a compartir, vender, alquilar tu información personal con otras partes. Puedo compartir cierta información con los proveedores de servicios de terceros autorizados necesarios para prestarte algunos servicios.
 <br></br>
 <br></br>
 <br></br>
<b>11. PLUGINS SOCIALES</b>
<br></br>
...
Instagram: https://help.instagram.com/155833707900388
 ...
 <br></br>
 <br></br>
<b>12. ACEPTACIÓN, CONSENTIMIENTO Y REVOCABILIDAD</b>
<br></br>
El Usuario declara haber sido informado de las condiciones sobre protección de datos de carácter personal, aceptando y consintiendo el tratamiento de los mismos por parte de Asesorias Valdivia en la forma y para las finalidades indicadas en el aviso legal.
<br></br>
